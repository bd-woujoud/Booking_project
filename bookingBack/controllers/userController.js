...
module.exports = {
  ...
  sendMail: function (req, res, next) {
    ...
    var mailOptions = {
      ...
      subject: "Demande de reservation", // Subject line
      // text: 'bonjour monsieur', // plain text body
      html: "nous avons recus votre demande de reservation, et nous rentrons vers dés que possible"
    };
  ...
  sendContact: function (req, res, next) {
    ...
    var mailOptions = {
      ...
      from: process.env.MAIL,  // sender address
      to: req.body.to,// list of receivers
      subject: "reclamation", // Subject line
  ...
  sendMailto: function (req, res, next) {
    ...
    var mailOptions = {
      ...
      from: process.env.MAIL,  // sender address
      to: req.body.to,// list of receivers
      subject: "Reponse à votre email", // Subject line
      // text: 'bonjour monsieur', // plain text body
      html: req.body.message
    };
